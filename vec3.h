...
// vec3 code from https://raytracing.github.io/books/RayTracingInOneWeekend.html
...
inline void vec3::make_unit_vector() {
    // Divide each component by norm/length
    *this /= length();
}

inline void vec3::square_root() {
    e[0] = sqrtf(e[0]);
    e[1] = sqrtf(e[1]);
    e[2] = sqrtf(e[2]);
...
inline vec3 unit_vectorize(vec3 v) {
    return v /= v.length();
}
